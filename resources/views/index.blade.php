    ...
    <body>
							...
							<ul class="nav navbar-nav navbar-right">
							  <li class="dropdown">
								...
								<ul class="dropdown-menu">
								  <li><a href="">E</a></li>
								  <li><a href="">Ngolo Kante</a></li>
								  <li><a href="">Andreas Christensen</a></li>
								  <li><a href="">Mateo Kovacic</a></li>
								  <li><a href="">Jorginho</a></li>
								</ul>
							  </li>
							</ul>
							</nav>
		...
		snippets in the 100% free Bootply.com code repository.
							  ...
							  <h4 class="text-center">
								<sub><a href="http://facebook.com/chukwudi/udeh" target="ext">Design by Chukwudi Udeh</a></sub>
							  </h4>
